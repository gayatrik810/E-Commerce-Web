	    ...
	    <div class="xs">
            <div class="panel panel-warning" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static="">
                ...
                include "config.php";
                        if($_GET['ID'])
                        {
                            $view = mysqli_query($con,"select * from users where id='".$_GET['ID']."'") or die(mysqli_error($con));
                ...
                <br>
                    <label >Subject</label>
                    <input type="text" name="password" value="<?php echo $row['password'];?>" class="form-control1" >
                <br>
                    <label >URL</label>
                    <input type="text" name="contact" value="<?php echo $row['contact'];?>" class="form-control1" >
                <br>
                    <label>Message</label>
                    <input type="text" name="city" value="<?php echo $row['city'];?>" class="form-control1" >
                    <label>Message</label>
                    <input type="text" name="address" value="<?php echo $row['address'];?>" class="form-control1" >
                <br><br>
