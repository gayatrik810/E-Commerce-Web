   ...
   <body>
               ...
               <ul class="rslides" id="slider4">
                  ...
                  <li>
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              <h5>Om Sai Tyres<br> Auto Services</h5>
                              <div class="bottom-info">
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <a href="products.php"><img src="images/omty4.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">MRF</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <a href="products.php"><img src="images/omty7.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">MRF</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 text-center banner-agile-flowers">
                  <a href="products.php"><img src="images/omty2.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">MRF</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <a href="products.php"><img src="images/omty8.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">MRF</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  <a href="products.php"><img src="images/omty9.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">MRF</h4>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                 <a href="products.php"><img src="images/omty3.jpg" class="img-thumbnail" alt=""></a>
                  <div class="banner-right-icon">
                     <h4 class="pt-3">MRF</h4>
                  </div>
               </div>
               <div class="toys-grids-upper">
                  <div class="about-toys-off">
                     <h2>Get Up to <span>70% Off </span>On Selected Tyres</h2>
                  </div>
               </div>
            </div>
         </div>
               ...
               <ul id="flexiselDemo1">
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="images/naty8.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3"></h4>
                        </div>
                        <div class="outs_more-buttn">
                           <a href="products.php">Book Now</a>
                        </div>
                     </div>
                  </li>
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="images/naty2.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3"></h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="images/naty3.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3"></h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid ">
                        <img src="images/naty4.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3"></h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid">
                        <img src="images/naty5.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3"></h4>
                        </div>
                        <div class="outs_more-buttn">
                  ...
                  <li>
                     <div class="agileinfo_port_grid ">
                        <img src="images/naty6.jpg" alt=" " class="img-fluid" />
                        <div class="banner-right-icon">
                           <h4 class="pt-3"></h4>
                        </div>
                        <div class="outs_more-buttn">
      ...
      <section class="product py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            <h1 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3"><a class="animate-charcter" href="index.php">OM SAI TYRE & AUTO SERVICES</a></h1>
